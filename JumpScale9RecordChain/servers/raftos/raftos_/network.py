...
class UDPProtocol(asyncio.DatagramProtocol):
    ...
    def datagram_received(self, data, sender):
        ...
        #THIS IS FOR DEBUG PURPOSES, TO SEE CHANGED MESSAGES
        if data["term"]!=self.last["term"] or  data["type"]!=self.last["type"]: 
            print(data)
            print(sender)
            self.last["term"]=data["term"]
            self.last["type"]=data["type"]
